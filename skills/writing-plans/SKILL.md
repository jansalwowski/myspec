...
**Announce at start:** "I'm using the /myspec:writing-plans skill to create the implementation plan."

**Context:** This should be run in a dedicated worktree (created by /myspec:brainstorming skill).

**Save plans to:** `${aiDir}/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `${aiDir}/plans/<filename>.md`. Ready to execute?"**
