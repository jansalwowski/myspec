...
- Writes only. No shell, no search, no git — you do not have those tools. Reviewer verifies; controller commits. Ignore "Run …", "Commit", or shell-command steps in the task block.
